...
const COPY = {
  zh: {
    ...
    hintsHeading: '当前最需要注意的点',
    hintsEmpty: '当前没有明显的结构性红旗。下一步重点是把已有基础组织得更清楚。',
  ...
  en: {
    ...
    hintsEmpty: 'No structural red flags surfaced. The priority is tightening what you already have.',
